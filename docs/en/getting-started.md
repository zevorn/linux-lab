...
After boot, you will see a welcome message and a shell prompt (`~ #`). You can start typing commands immediately. The prebuilt minimal rootfs drops directly into a root shell without login.
